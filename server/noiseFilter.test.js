...
const NOISE_CASES = [
  ...
  // '동아리'·'스터디' 단어 없이 '모임'·'부원'으로만 새던 캐주얼 클럽(실측, 링커리어 대외활동 57건 중 확인)
  "톡소다 3기 신입 부원 모집",
  "그린김에_그림모임 모집",
  "대학생 독서모임 《사유(思惟)》 2기 모집",
  "인삼 人三 (면접대비 스몰토크 모임)",
  "북신사 신입부원모집",
  "音楽部 (온가쿠부) 부원 모집",
  "올드패션드_ 맛있는 술만 즐기는 모임",
  // '공모전'·'봉사' 등 KEEP 키워드를 테마로 브랜딩했지만 '부원/멤버 모집' 문구가 있어 실제로는
  // 상시 운영되는 사설 동아리의 신입 모집인 것(실측, 대외활동 779건 중 42건이 이 패턴으로 샜음)
  "콘텐츠 공모전 동아리 -TARGETer- 신입부원 모집 중입니다",
  "데이터 분석 공모전 연합동아리 [ Discovery ] 부원 모집 중",
  "[WE DO] 대학생 프로젝트 봉사단 신입 부원 모집",
];

// 살려야 하는 것 (이력에 도움되는 대외활동 - 서포터즈·공모전·지자체 지원사업)
const KEEP_CASES = [
  "2026년 디지털성범죄예방동아리 '부엉이서포터즈 3기' 추가 모집", // 서포터즈(부원/회원/멤버 모집 아님)
  "서울 동아리ON 대학생 동아리 지원사업 참여자 모집",             // 지원사업(참여자 모집, 부원 모집 아님)
