...
// 값은 canonical REGIONS(13개)로 통일한다. 유저가 고르는 지역명과 같아야 매칭이 된다.
// 충남/충북/세종 -> 충청, 전남/전북 -> 전라, 경남/경북 -> 경상 (regionLookup의 PROVINCE 매핑과 동일).
const REGION_PREFIX = {
  11: "서울", 26: "부산", 27: "대구", 28: "인천", 29: "광주", 30: "대전", 31: "울산", 36: "충청",
  41: "경기", 42: "강원", 43: "충청", 44: "충청", 45: "전라", 46: "전라", 47: "경상", 48: "경상", 50: "제주",
};
