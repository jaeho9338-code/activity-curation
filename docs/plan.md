...
대학생이 대외활동·공모전·장학·봉사에 지원하려 할 때, 공고가 여러 사이트에 흩어져 있고 각 사이트는
...
공통(둘 다)
- 나이(만 나이), 학년·학기, 재학 상태(재학·휴학·졸업예정 등), 전공 계열, 소속 대학과 그 소재 지역, 거주 지역, 국적
...
현실성 요약: 위비티 한 소스로 끝까지 돌려보고 확장한다. AI는 하루 신규분만 처리해 비용을 통제한다.
이번 범위는 위비티 한 소스, 트랙 둘, 조회·매칭 화면까지. 알림·결제·앱·다중 소스는 다음으로.
